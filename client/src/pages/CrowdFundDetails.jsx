...
const CrowdFundDetails = () => {
  ...
  return (
    <div className="  flex max-md:flex-row flex-col justify-between overflow-y-auto p-4">
      <div className=" flex_fix_invert">
        ...
        <div className=" flex flex-col p-3 bg-red-00  pt-14 w-1/2 max-md:w-[90%] mx-auto">
