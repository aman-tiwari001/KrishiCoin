    ...
    <div className="bg-[#E0FCE7] bg-cover w-full h-[80px] z-20 fixed top-0 flex items-center justify-between py-2 px-6 shadow-md">
      ...
      <div className="flex justify-center items-center gap-2">
		<div className="dropdown">
		  <div tabIndex={0} role="button" className="btn btn-ghost btn-circle bg-[#209b2e] hover:bg-[#1b522197] transition-all duration-300">
			<svg
		  ...
		  >
			{NavItems.map((item, index) => (
					<li key={index}>
					  <Link to={item.link} className="menu-title text-green-700 rounded-lg hover:bg-lime-100 transition-all hover:shadow-lg">
						{item.name}
					  </Link>
					</li>
				  ))}
